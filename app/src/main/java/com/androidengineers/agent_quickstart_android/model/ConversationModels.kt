...
data class ConversationUiState(
    ...
    val issues: List<SessionIssue> = emptyList(),
    val actionRequest: com.androidengineers.agent_quickstart_android.actions.ActionRequest? = null,
    val actionState: com.androidengineers.agent_quickstart_android.actions.ActionState = com.androidengineers.agent_quickstart_android.actions.ActionState.PENDING,
)
